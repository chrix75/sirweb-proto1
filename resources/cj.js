{ code: 1, label:"Entrepreneur individuel" },
{ code: 11, label:"Artisan-commerçant" },
{ code: 1100, label:"Artisan-commerçant" },
{ code: 12, label:"Commerçant" },
{ code: 1200, label:"Commerçant" },
{ code: 13, label:"Artisan" },
{ code: 1300, label:"Artisan" },
{ code: 14, label:"Officier public ou ministériel" },
{ code: 1400, label:"Officier public ou ministériel" },
{ code: 15, label:"Profession libérale" },
{ code: 1500, label:"Profession libérale" },
{ code: 16, label:"Exploitant agricole" },
{ code: 1600, label:"Exploitant agricole" },
{ code: 17, label:"Agent commercial" },
{ code: 1700, label:"Agent commercial" },
{ code: 18, label:"Associé gérant de Société" },
{ code: 1800, label:"Associé gérant de Société" },
{ code: 19, label:"(Autre) Personne physique" },
{ code: 1900, label:"(Autre) Personne physique" },
{ code: 2, label:"Groupement de droit privé non doté de la personnalité morale" },
{ code: 21, label:"Indivision" },
{ code: 2110, label:"Indivision entre personnes physiques" },
{ code: 2120, label:"Indivision avec personne morale" },
{ code: 22, label:"Société créée de fait" },
...
{ code: 23, label:"Société en participation" },
...
{ code: 24, label:"Fiducie" },
{ code: 2400, label:"Fiducie" },
{ code: 27, label:"Paroisse hors zone concordataire" },
{ code: 2700, label:"Paroisse hors zone concordataire" },
{ code: 29, label:"Autre groupement de droit privé non doté de la personnalité morale" },
{ code: 2900, label:"Autre groupement de droit privé non doté de la personnalité morale" },
{ code: 3, label:"Personne morale de droit étranger" },
{ code: 31, label:"Personne morale de droit étranger, immatriculée au RCS (registre du commerce et des sociétés)" },
{ code: 3110, label:"Représentation ou agence commerciale d'état ou organisme public étranger immatriculé au RCS" },
{ code: 3120, label:"Société commerciale étrangère immatriculée au RCS" },
{ code: 32, label:"Personne morale de droit étranger, non immatriculée au RCS" },
...
{ code: 4, label:"Personne morale de droit public soumise au droit commercial" },
{ code: 41, label:"Etablissement public ou régie à caractère industriel ou commercial" },
{ code: 4110, label:"Établissement public national à caractère industriel ou commercial doté d'un comptable public" },
{ code: 4120, label:"Établissement public national à caractère industriel ou commercial non doté d'un comptable public" },
...
{ code: 5, label:"Société commerciale" },
{ code: 51, label:"Société coopérative commerciale particulière" },
...
{ code: 5370, label:"Société de Participations Financières de Profession Libérale Société en commandite par actions (SPFPL SCA)" },
{ code: 5385, label:"Société d'exercice libéral en commandite par actions" },
{ code: 54, label:"Société à responsabilité limitée (SARL)" },
...
{ code: 5470, label:"Société de Participations Financières de Profession Libérale Société à responsabilité limitée (SPFPL SARL)" },
{ code: 5485, label:"Société d'exercice libéral à responsabilité limitée" },
{ code: 5498, label:"SARL unipersonnelle" },
{ code: 5499, label:"Société à responsabilité limitée (sans autre indication)" },
{ code: 55, label:"Société anonyme à conseil d'administration" },
...
{ code: 5520, label:"Société d'investissement à capital variable (SICAV) à conseil d'administration" },
...
{ code: 5570, label:"Société de Participations Financières de Profession Libérale Société anonyme à conseil d'administration (SPFPL SA à conseil d'administration)" },
...
{ code: 56, label:"Société anonyme à directoire" },
...
{ code: 5620, label:"Société d'investissement à capital variable (SICAV) à directoire" },
...
{ code: 5670, label:"Société de Participations Financières de Profession Libérale Société anonyme à Directoire (SPFPL SA à directoire)" },
{ code: 5685, label:"Société d'exercice libéral à forme anonyme à directoire" },
{ code: 5699, label:"SA à directoire (s.a.i.)" },
{ code: 57, label:"Société par actions simplifiée" },
{ code: 5710, label:"SAS, société par actions simplifiée" },
{ code: 5720, label:"Société par actions simplifiée à associé unique ou société par actions simplifiée unipersonnelle" },
{ code: 5770, label:"Société de Participations Financières de Profession Libérale Société par actions simplifiée (SPFPL SAS)" },
{ code: 5785, label:"Société d'exercice libéral par action simplifiée" },
{ code: 58, label:"Société européenne" },
{ code: 5800, label:"Société européenne" },
{ code: 6, label:"Autre personne morale immatriculée au RCS" },
{ code: 61, label:"Caisse d'épargne et de prévoyance" },
{ code: 6100, label:"Caisse d'Épargne et de Prévoyance" },
{ code: 62, label:"Groupement d'intérêt économique" },
{ code: 6210, label:"Groupement européen d'intérêt économique (GEIE)" },
{ code: 6220, label:"Groupement d'intérêt économique (GIE)" },
{ code: 63, label:"Société coopérative agricole" },
...
{ code: 64, label:"Société d'assurance mutuelle" },
{ code: 6411, label:"Société d'assurance à forme mutuelle" },
{ code: 65, label:"Société civile" },
...
{ code: 69, label:"Autre personne morale de droit privé inscrite au registre du commerce et des sociétés" },
{ code: 6901, label:"Autre personne de droit privé inscrite au registre du commerce et des sociétés" },
{ code: 7, label:"Personne morale et organisme soumis au droit administratif" },
{ code: 71, label:"Administration de l'état" },
{ code: 7111, label:"Autorité constitutionnelle" },
{ code: 7112, label:"Autorité administrative indépendante" },
...
{ code: 72, label:"Collectivité territoriale" },
...
{ code: 73, label:"Etablissement public administratif" },
...
{ code: 74, label:"Autre personne morale de droit public administratif" },
...
{ code: 8, label:"Organisme privé spécialisé" },
{ code: 81, label:"Organisme gérant un régime de protection sociale à adhésion obligatoire" },
...
{ code: 82, label:"Organisme mutualiste" },
{ code: 8210, label:"Mutuelle" },
{ code: 8250, label:"Assurance mutuelle agricole" },
{ code: 8290, label:"Autre organisme mutualiste" },
{ code: 83, label:"Comité d'entreprise" },
{ code: 8310, label:"Comité central d'entreprise" },
{ code: 8311, label:"Comité d'établissement" },
{ code: 84, label:"Organisme professionnel" },
...
{ code: 85, label:"Organisme de retraite à adhésion non obligatoire" },
{ code: 8510, label:"Institution de prévoyance" },
{ code: 8520, label:"Institution de retraite supplémentaire" },
{ code: 9, label:"Groupement de droit privé" },
{ code: 91, label:"Syndicat de propriétaires" },
{ code: 9110, label:"Syndicat de copropriété" },
{ code: 9150, label:"Association syndicale libre" },
{ code: 92, label:"Association loi 1901 ou assimilé" },
...
{ code: 93, label:"Fondation" },
{ code: 9300, label:"Fondation" },
{ code: 99, label:"Autre personne morale de droit privé" },
